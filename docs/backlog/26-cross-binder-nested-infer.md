...
`crates/typokat-types/src/types/repr.rs` /
`crates/typokat-types/src/types/substitute/mod.rs` (index arithmetic),
`crates/typokat-check/src/check/checker/annotations/` (lowering: drop the poison, bind
across frames with shifts),
`crates/typokat-check/src/check/checker/eval/` (`substitute_infers` descent), `m25_conditional_types/

...
own architecture doc, "the CPU-heavy core" (`crates/typokat-relate/src/relate/`, architecture §6) — and a consumer
...
profiling harness. No changes to `crates/typokat-relate/src/relate/`.

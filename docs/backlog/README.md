...
- [`37`](37-constraint-approximation-deferred-args.md) — TK2344 constraint approximation for provable deferred arguments (`Uppercase<Extract<K, string>>` over-report; M28 round-3 arbitration).

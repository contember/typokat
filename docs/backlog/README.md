...
Silent-FN kills (highest value per effort, schedule first):
...
1. **Kill the known silent-FN families** (C's first group: `33`, `34`, `32`, `21`, `22`) — small,
   and every one is a dropped-error class.

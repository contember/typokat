...
- **XL** · [`103`](103-library-merge-panics-and-routing.md) — merging a declaration into the frozen library **panics** (`declare global`, `interface Window`, `namespace Intl`); no collision route exists. Blocks the WU7 CLI cutover.

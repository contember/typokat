...
- [`sprint-2026-08-08-real-project-rescreen.md`](sprint-2026-08-08-real-project-rescreen.md) —
  active: re-screen the same six immutable public candidates against the shipped acyclic named
  source-re-export route, with unchanged zero thresholds and no production broadening.

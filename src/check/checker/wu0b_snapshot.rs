//! Test-only WU0B semantic snapshot feasibility archive.
...
use super::wu0b_library::{
    compile_owned_injected_profile, InjectedLibrarySource, OwnedLibraryRuntimeSnapshotParts,
...
pub(super) use super::wu0b_snapshot_runtime::check_source_with_decoded_base_for_test;
...
pub(in crate::check::checker) fn decode_snapshot_for_test(
    ...
    if strategy == SnapshotDecodeStrategy::ImmutableIndexed {
        return Err(invalid(
            ...
            "immutable-indexed materialization is optional in WU0B",
        ));
    }
...
impl SnapshotFastCleanProbeRecordForTest {
    pub(in crate::check::checker) fn render(&self) -> String {
        format!(concat!("TYPOKAT_WU0B_PROBE={{\"schema\":1,\"kind\":\"eager-fast-clean\",\"route\":\"{}\",\"profile_sha256\":\"{}\",", "\"strategy\":\"eager-complete\",\"artifact_sha256\":\"{}\",\"artifact_bytes\":{},\"validated_bytes\":{},", "\"runtime_projection_sha256\":\"{}\",\"input_path\":{},", "\"semantics\":{{\"fast_clean\":{{\"exit\":{},\"diagnostics\":{}}},\"fast_errors\":{{\"exit\":{},\"diagnostics\":{}}}}},", "\"compiler_measure\":{{\"source_loads\":{},\"parse_units\":{},\"bind_units\":{},\"semantic_units\":{},\"snapshot_generations\":{}}},", "\"internal\":{{\"validation_us\":{},\"decode_us\":{},\"user_check_us\":{},\"wall_us\":{},\"peak_rss_bytes\":{}}}}}"),

//! Disabled RED contract for WU5 replay-index admission and physical-work scaling.

use super::base::{
    PrivateExecutionForTest, ReplayIndexMutationForTest, UserDeltaProjectInputForTest,
};

...
records 34 projects and both root orders against pinned `tsc 6.0.3`. The admitted rows cover named
...
default/named slots, a named default function that closes an adjacent overload group, missing
modules/defaults, and both wrong-space barriers. The expression-owned

...
interface InterfaceTraversal {
  ...
  [computedSibling]: AvailableInterface.Good | MissingComputedSibling.Child; // incomplete[signature/property-signature/computed-key]: computed property signature key not visited | error[TK2503]: Cannot find namespace 'MissingComputedSibling'
  later: MissingLater.Child; // error[TK2503]: Cannot find namespace 'MissingLater'
}

interface HeritageTraversal extends AvailableInterface.Good, MissingHeritage.Child {} // error[TK2503]: Cannot find namespace 'MissingHeritage'

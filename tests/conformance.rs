...
//!
//! M0–M15 (`m0_assign_primitives/`, `m1_binder_inference/`, `m2_objects/`,
...
//! `m15_accessors/`) are enabled. The `MILESTONE_DIRS` table is the extension point:
//! flip a row to turn a milestone's fixtures on as it lands (mvp-plan §5).
